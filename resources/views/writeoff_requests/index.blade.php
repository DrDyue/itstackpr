        ...
        <form method="GET" action="{{ route('writeoff-requests.index') }}" class="surface-toolbar grid gap-4 md:grid-cols-3">
            ...
            <label class="block">
                ...
                <x-searchable-select
                    ...
                    identifier="writeoff-request-status-filter"
                        ...
                        <div class="rounded-[1.5rem] border border-slate-200 bg-white p-4 shadow-sm">
                            ...
                            <div class="mt-3 grid gap-3 text-sm text-slate-600">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 text-slate-700">{{ $request->device?->status === 'active' ? 'Aktiva' : ($request->device?->status === 'repair' ? 'Remonta' : 'Norakstita') }}</div>
                                </div>
