<x-app-layout>
    <section class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-gray-900">Jauna komplekta pozicija</h1>
        ...
        <form method="POST" action="{{ route('device-set-items.store') }}" class="crud-form-card">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="role" maxlength="50" value="{{ old('role') }}" class="crud-control" placeholder="Piemers: galvenais dators">
                </div>
            </div>
