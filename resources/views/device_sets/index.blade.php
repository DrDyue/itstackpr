                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-50 text-xs uppercase tracking-wide text-gray-600">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">Atbildigais</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex flex-wrap items-center gap-3">
                                        <a href="{{ route('device-sets.edit', $set) }}" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <a href="{{ route('device-sets.edit', $set) }}#add-device-form" class="inline-flex items-center gap-2 text-emerald-600 hover:text-emerald-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/>
                                            </svg>
                                            Pievienot ierici
                                        ...
                                        <form method="POST" action="{{ route('device-sets.destroy', $set) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Dzest so komplektu?')" class="inline-flex items-center gap-2 text-red-600 hover:text-red-700">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-4 py-8 text-center text-gray-500">Komplekti vel nav pievienoti.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
