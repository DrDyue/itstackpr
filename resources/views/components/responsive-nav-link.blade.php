...
$classes = ($active ?? false)
            ? 'block w-full whitespace-nowrap rounded-2xl bg-sky-50 px-4 py-3 text-start text-base font-semibold text-sky-800 ring-1 ring-sky-200 shadow-sm transition duration-150 ease-in-out'
