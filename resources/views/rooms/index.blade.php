                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-50 text-xs uppercase tracking-wide text-gray-600">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">Eka</th>
                            <th class="px-4 py-3 text-left">Stavs</th>
                            ...
                            <th class="px-4 py-3 text-left">Nodala</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('rooms.edit', $room) }}" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        ...
                                        <form method="POST" action="{{ route('rooms.destroy', $room) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Dzest so telpu?')" class="inline-flex items-center gap-2 text-red-600 hover:text-red-700">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-4 py-8 text-center text-gray-500">Telpas vel nav pievienotas.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
